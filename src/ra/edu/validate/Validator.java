...
public class Validator {
    ...
    public static int validateInt(Scanner scanner,int min,int max,String message) {
        while (true){
    ...
    public static String validateString(Scanner scanner,int minLength,int maxLength,String message){
        while(true){
            System.out.print(message);
            ...
            if(input.isEmpty()){
                ...
                System.out.println("Độ dài dữ liệu không hợp lệ");
            }else {
                return input;
            }
        }
